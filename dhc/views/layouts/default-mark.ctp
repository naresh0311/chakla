...
<body>
	<div id="container">
			...
			<?php $userAgent=$this->Session->read('Auth.User'); ?>
				...
				<br />
				<a href="<?php echo HOST_ADDRESS; ?>" title="View the Site">View the Site</a> | <a href="<?php echo HOST_ADDRESS; ?>admin/users/logout" title="Sign Out">Sign Out</a>
			</div>        
			...
			{
				?><li><a href="<?php echo HOST_ADDRESS; ?>admin/categories" class="nav-top-item-blue  no-submenu <?php if($this->name=="Categories" && $this->data['Category']['id']!=100001){ echo " current";} ?>">
			Categories</a></li><?php
			}
			...
			{
				?><li><a href="<?php echo HOST_ADDRESS; ?>admin/categories/edit/100001" class="nav-top-item-blue  no-submenu <?php if($this->name=="Categories" && $this->data['Category']['id']==100001){ echo " current";} ?>">
			Home Rotator</a></li><?php
			}
