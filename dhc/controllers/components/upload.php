  ...
  function startup (&$controller) {
	...
	function upload ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
			...
			if (isset($file) && is_array($file) && !$this->upload_error($file['error'])) 
			{
				...
				$this->error("Possible file upload attack... this is the message");
			}
		}



function uploadsong ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
